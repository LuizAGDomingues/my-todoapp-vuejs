<template>
  <div class="tasks-container" >
    <div class="tasks-input">
      ...
      <span @click="updateTodo" :class="{'tasks-text-unchecked': isCompleted === false, 'tasks-text-checked': isCompleted === true}">{{todo.title}}</span>
    </div>
  ...
  <Modal v-if="openModal" v-on:closeModal='closeModal' />
