...
<template>
  <div class="container">
    ...
    <form action="submit" class="input" @submit.prevent="addTodo">
      ...
      <div class="input-container">
        ...
        <button @click.prevent="addTodo" class="input-button" type="submit"><i class="ph-check-square input-button-icon"></i></button>
      </div>
    </form>
